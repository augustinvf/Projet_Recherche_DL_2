...
optimizer_ss = torch.optim.Adam(list(model.backbone.parameters()) + list(model.projection.parameters()), 0.0003, weight_decay=1e-4)
...
optimizer_su = torch.optim.Adam(model.classifier.parameters(), 0.001, weight_decay=1e-5)
