...
optimizer_ss = torch.optim.Adam(list(model.backbone.parameters()) + list(model.projection_head.parameters()), 0.6, weight_decay=1e-6)
...
optimizer_su = torch.optim.Adam(model.classifier.parameters(), 0.2, weight_decay=1e-3)
