...
optimizer_ss = torch.optim.Adam(list(model.backbone.parameters()) + list(model.projection_head.parameters()), 0.3, momentum = 0.9, weight_decay=1e-6)
...
optimizer_su = torch.optim.Adam(model.classifier.parameters(), 0.1, momentum = 0.9, weight_decay=1e-3)
